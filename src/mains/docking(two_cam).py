...
class Docking:
    def __init__(self):
        ...
        self.star_cam_sub = rospy.Subscriber(
            "/camera1/usb_cam/image_raw", Image, self.star_cam_callback
        )
        self.bow_cam_sub = rospy.Subscriber(
            "/camera2/usb_cam/image_raw", Image, self.bow_cam_callback
        )

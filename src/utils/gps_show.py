...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        l1_p = visual.point_rviz(
            name="fixed", id=ids.pop(), x=l1_re_x, y=l1_re_y, color_g=255, scale=0.2
        )
        l2_p = visual.point_rviz(
            name="fixed", id=ids.pop(), x=l2_re_x, y=l2_re_y, color_r=255, scale=0.2
        )
        l3_p = visual.point_rviz(
            name="fixed", id=ids.pop(), x=l3_re_x, y=l3_re_y, color_r=255, scale=0.2
        )
        l4_p = visual.point_rviz(
            name="fixed", id=ids.pop(), x=l4_re_x, y=l4_re_y, color_r=255, scale=0.2
        )
        l5_p = visual.point_rviz(
            name="fixed", id=ids.pop(), x=l5_re_x, y=l5_re_y, color_r=255, scale=0.2
        )
        d1_p = visual.point_rviz(
            name="fixed", id=ids.pop(), x=d1_re_x, y=d1_re_y, color_b=255, scale=0.2
        )
        d2_p = visual.point_rviz(
            name="fixed", id=ids.pop(), x=d2_re_x, y=d2_re_y, color_b=255, scale=0.2
        )
